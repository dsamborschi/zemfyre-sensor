...
module.exports.init = function (app) {
    async function trialTask (app) {
        console.log('Running trial task')
            ...
            try {
                if (subscription.Team) {
                    if (subscription.isActive()) {
                        ...
                        console.log(`Team ${subscription.Team.hashid} ending trial - billing setup`)
                        ...
                        console.log(`Team ${subscription.Team.hashid} ending trial - suspending instances`)
                ...
                console.error(`Error handling expired trial subscription ${subscription.subscription}: ${err.toString()}`)
            }
        }
        ...
        for (const subscription of pendingEmailSubscriptions) {
            try {
                ...
                console.error(`Error handling trial subscription ${subscription.subscription}: ${err.toString()}`)
            }
        }
    }
