            ...
            <td valign="top"
                ...
                <div style="color:inherit;font-size:inherit;line-height:inherit">
                    <div style="padding-left:10px;padding-right:10px">
                        <div style="min-width:540px;max-width:1200px;Margin-left:auto;Margin-right:auto;border-collapse:collapse;border-spacing:0;background-color:#ffffff;background-position:center;background-repeat:no-repeat;background-size:100% 100%"
                             bgcolor="#ffffff">
                            <div>
                                <div style="color:inherit;font-size:inherit;line-height:inherit">
                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td align="center" valign="top"
                                                ...
                                                <div style="font-size:24px;font-weight:700;color:#1976d2;padding:20px 0;">
                                                    Iotistic Platform
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td align="center" valign="top"
                                                ...
                                                <p style="font-family:Helvetica,Arial,sans-serif;font-size:12px;font-weight:normal;text-decoration:none;font-style:normal;color:#33475b">
                                                    © 2025 Iotistic Platform. All rights reserved.
                                                </p>
                                            </td>
                                        </tr>
                                        </tbody>
