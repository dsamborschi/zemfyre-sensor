...
import SystemMetrics from './cards/SystemMetrics.vue'
import ApplicationStats from './cards/ApplicationStats.vue'
</script>

<template>
  <h1 class="page-title font-bold">Dashboard</h1>
  <section class="flex flex-col gap-4">
    <!-- System Metrics and Application Stats Section -->
    <div class="flex flex-col lg:flex-row gap-4">
      <SystemMetrics class="w-full lg:w-2/3" />
      <ApplicationStats class="w-full lg:w-1/3" />
    </div>
